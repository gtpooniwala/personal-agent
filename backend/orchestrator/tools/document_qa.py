...
class DocumentQATool(BaseTool):
    ...
    name = "document_qa"
    description = """Document Q&A tool for searching and answering questions about uploaded documents.
...
The document Q&A tool will then search through your selected documents to find relevant information."""
            ...
            # Perform document search (synchronous version to avoid event loop conflicts)
